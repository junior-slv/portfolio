...
const Contact = () => {
  ...
  const sendEmail = (e:any) => {
    ...
    emailjs.sendForm('service_oba9ldh', 'template_l0ve2yr', form.current, 'PaGGExwC2uHF1Prkx')
    e.target.reset()
  };
  return (
          ...
          <div className="contact__content">
            ...
            <form ref={form} onSubmit={sendEmail} className="contact__form">
              ...
              <div className="contact__form-div contact__form-area">
                ...
                <textarea name="project" cols={30} rows={10} className='contact__form-input' placeholder='Escreva sobre seu projeto'>
